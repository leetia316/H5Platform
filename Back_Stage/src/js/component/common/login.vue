			...
			<div class="dialog_main">
				<div class="user">
					<div class="item">
						...
						<input id="login_user_name" type="text" placeholder="请输入用户名" v-bind:class="{'erro_input':erro.target == 'user_name'}" v-model="user_name" @blur="bl" @focus="fo"></input>					
					</div>
					<div class="item">
						<label for="password">密码：</label>
						<input id="login_password" type="password" placeholder="请输入密码" v-bind:class="{'erro_input':erro.target == 'password'}" v-model="password" @blur="bl" @focus="fo"></input>	
					</div>
